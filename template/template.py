...
CONSUMER_KEY = 'paste_from_twitter_dev'
CONSUMER_SECRET = 'paste_from_twitter_dev'
ACCESS_TOKEN_KEY = 'paste_from_twitter_dev'
ACCESS_TOKEN_SECRET = 'paste_from_twitter_dev'
